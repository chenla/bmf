...
Elevations are traditionally given on earth as feet or meters above
sea level.

That will change over time -- we need a means of establishing what sea
level is for a given period of time....
...
So if you are in a manmade structure we need a different notation
  ...
  15+9m would be 15 meters above sea level an 9 meters above ground
  level.
