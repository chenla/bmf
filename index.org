...
So let's move meaning and knowledge out of our model and
use the terms to refer to particular states of collections
of information that have gone through iterative processes of
building cognitive models of the world.

What we will focus on in preserving context.  We have
already discussed preserving references but how we do this
is no as straight forward as it might seem at first.

We will call here references that are matched with a pointer
to the source of the reference or a definition or record
describing them /links/.  Links can be 
...
These limitations can include:
  ...
  - the physical senses :: visual, audio, smell
