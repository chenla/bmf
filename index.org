...
Horcruxes come in three flavours:

 - hoards :: hold the data and do first pass processing on that data
...
There are likely going to be different types of maps as
well, some will be to create databases for search engines,
others to export into user-formats for people to be able to
read.
