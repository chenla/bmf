...
:sub:  per:PraiYut_Jaksan 
:pred: rel:born
:obj:  bmf:dt="2044-2-20:21:22+7" geo:Bangkok_Phuket_Hospital
:src:  self
:cite: citē:yut:2044birth-cert
:conf: high
:END:

#+begin_quote
[[per:][Prai Yut]] was [[rel:born][born]] on [[bmf:dt][20 feb 2044]] in [[geo:][Bangkok-Phuket Hospital]]
